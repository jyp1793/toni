		...
		<div class="row product-row">
			...
			<div class="col-md-3 product-left">
				<div class="product-search">
					<input type="text" class="form-control common-text"> <a
						href="" class="glyphicon glyphicon-search"></a>
				</div>

				<div class="product-category panel-group" id="accordion">
					<span>카테고리</span>
					<ul class="panel">
						<li class="subtype"><a href="#kinds" class="kinds"
							data-toggle="collapse" data-parent="#accordion"> <span
								class="left">종류</span> <span
								class="glyphicon glyphicon-chevron-down arrow-down right"></span>
						</a></li>
					...
					<ul class="panel">
						<li class="subtype"><a href="#alcont" name="alcont"
							data-toggle="collapse" data-parent="#accordion"> <span
								class="left">도수</span> <span
								class="glyphicon glyphicon-chevron-down arrow-down right"></span>
						</a></li>
					...
					<ul class="panel">
						<li class="subtype"><a href="#age" name="age"
							data-toggle="collapse" data-parent="#accordion"> <span
								class="left">나이</span> <span
								class="glyphicon glyphicon-chevron-down arrow-down right"></span>
						</a></li>
					...
					<ul class="panel">
						<li class="subtype"><a href="#price" name="price"
							data-toggle="collapse" data-parent="#accordion"> <span
								class="left">가격</span> <span
								class="glyphicon glyphicon-chevron-down arrow-down right"></span>
						</a></li>
				...
				<c:forEach var="vo" items="${list}">
					<li class="col-xs-12 col-sm-6 col-md-4 product-li">
						<div class="product-img">
							<img src="${pageContext.request.contextPath }/resources/img/product/${vo.p_imgAddr}" alt="사진입니다">
						</div>
						<div class="product-info">
							<div class="product-name">${vo.p_name }</div>
							<div class="product-content">${vo.p_volume }</div>
							<div class="product-price">
								<fmt:formatNumber value="${vo.p_price }" type="currency" currencySymbol="￦" />
							</div>
						</div>
						<div class="product-detail-hover">
							<a href="productDetail?pno=${vo.pno }"></a>
						</div>
					</li>
				</c:forEach>
			</ul>
...
<section>
	<div class="container common-paginationWrap">
